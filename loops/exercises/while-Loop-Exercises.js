...
numOfAstronauts = input.question('Enter the number of users on board: ') 
  if (numOfAstronauts > 7) {
    numOfAstronauts += 'Too many on board, Try again.'
  } else { 
    numOfAstronauts += 'Not enough astronauts on board. Try again';
  }
;
